    ...
    useEffect(() => {
        ...
        if (selectedGenre) {
            ...
            axios.get(`${URL}/genres/${genre[0].id}/audio-features`).then((response) => {
                ...
                console.log(response.data[0].acousticness.toPrecision(3));
            })
        }
        ...
        <section className='inspiration'>
            ...
            <div className='inspiration__insights'>
                ...
                <div className='inspiration__container'>
                    <div className='inspiration__queries'>
                        <div className='inspiration__query'>
                            <h3>Acousticness</h3>
                            <input type="number" readOnly={false} min={0} max={1} step={0.001} value={audioFeatures ? acousticness : 0} onChange={(e) => {setAcousticness(e.target.value)}}/>
                            <input type="range" min={0} max={1} step={0.001} value={audioFeatures ? acousticness : 0} onChange={(e) => {setAcousticness(e.target.value)}}/>
                        </div>
